  ...
  return (
    <section className="app-section">
      <div className="container">
        <h2 className="section-title">Simplifiez vos réservations avec notre application</h2>
        ...
        >
          ...
          <motion.div className="app-info" variants={itemVariants}>
            ...
            <div className="app-download">
              ...
              <a href="#" aria-label="Télécharger sur App Store">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Colonne droite: cartes et boutons de téléchargement */}
          <motion.div className="app-cards" variants={itemVariants}>
